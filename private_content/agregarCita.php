    ...
    <body>
        ...
        <div id="contenedor" class="container">
            <ul class="nav nav-tabs" id="myTab">
                ...
                <li class=""><a href="#Expediente">Guardar Cita</a></li>
                ...
                <div class="tab-pane active" id="Expediente">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <a href=agregarCita.php>Guardar Cita</a>
                            <?
                            include_once '../clases/db_connect.php';
                            if (isset($_POST['submitted'])) {
                                ...
                                $sql = "INSERT INTO `cita` ( `cod_cita` , `Nombre`, `fecha_cita` ,  `hora_cita` ,  `cod_doc` ) VALUES(  '{$_POST['cod_cita']}' ,  '{$_POST['nombre']}' , '{$_POST['fecha_cita']}' ,  '{$_POST['hora_cita']}' ,  '{$_POST['cod_doc']}' ) ";
                                mysql_query($sql) or die(mysql_error());
                                echo "Added row.<br />";
                                echo "<a href='Paciente.php'>Back To Listing</a>";
                            }
                            ?>
                            ...
                            <form action='' method='POST'> 
                                ...
                                <p><b>Fecha Cita:</b><br /><input type='text' name='fecha_cita'/> 
                                <p><b>Hora Cita:</b><br /><input type='text' name='hora_cita'/> 
